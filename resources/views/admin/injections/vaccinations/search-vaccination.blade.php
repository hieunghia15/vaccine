...
'title' => __($title ?? 'Tra cứu trạng thái tiêm chủng')
])
@section('main')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Tra cứu trạng thái tiêm chủng</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-white">
                        <h3 class="card-title" style="margin-top:0.25rem">Tra cứu trạng thái tiêm chủng</h3>
                    </div>
                    <!-- /.card-header -->
                    <form method="POST" action="{{ route('admin.injections.result-vaccination-status') }}" novalidate>
                        @csrf
