    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">275%</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Số người tiêm (>=3 mũi)</span>
                        <span class="info-box-number">562.678</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="row">
            ...
            <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#line-chart" data-toggle="tab">Line</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Số liệu vắc xin theo quận/huyện</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
