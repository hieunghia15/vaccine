@extends('admin.layout-admin', [
    'title' => __($title ?? 'Thống kê huyện Thới Lai'),
])
@section('main')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Thống kê huyện Thới Lai</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Thống kê huyện Thới Lai</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-chart-pie mr-1"></i>
                                Số liệu tiêm chủng huyện Thới Lai
                            </h3>
                        </div><!-- /.card-header -->
    ...
    <script type="text/javascript">
        ...
        var ward8 = {{ Js::from($ward8) }};
        var ward9 = {{ Js::from($ward9) }};
        var ward10 = {{ Js::from($ward10) }};
        var ward11= {{ Js::from($ward11) }};
        var ward12 = {{ Js::from($ward12) }};
        ...
        var myChart = new Chart(xtc, {
            ...
            data: {
                labels: [
                    ...
                    ward_label[6].name, ward_label[7].name, ward_label[8].name,
                    ward_label[9].name, ward_label[10].name, ward_label[11].name,
                    ward_label[12].name
                ],
                datasets: [{
                    label: 'Mũi tiêm',
